		...
		data: [
			{
				...
				duration: 104,
				label: '4,99 €',
				short_plot: 'Cuando el detective de talla mundial Harry Goodman desparece en circunstancias muy extrañas, su hijo Tim comienza un viaje para descubrir qué ha ocurrido. Aunque no lo hará solo, le ayudará un investigador adorable y muy divertido que solía ser el compañero Pokémon de Harry, el detective Pikachu...',
				images: {
